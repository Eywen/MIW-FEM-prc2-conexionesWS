...
public interface ISpikeRESTAPIService {
    ...
    @GET("{deviceid}/values/timeseries")
    Call<Sensors> getTelemetries(@Header("Authorization") String authorization, @Path("deviceid") String deviceId,
                                 @Query("keys") String keys, @Query("startTs") String startTs, @Query("endTs") String endTs);
